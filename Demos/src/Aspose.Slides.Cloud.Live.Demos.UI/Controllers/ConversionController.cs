using Aspose.Slides.Cloud.Live.Demos.UI.Models.Common;
		...
		public Response Conversion(string outputType)
		{
			...
			foreach (string fileName in Request.Files)
			{
				...
				if (postedFile != null)
				{
					...
					{
						AsposeSlidesConversion asposeThreeDConversion = new AsposeSlidesConversion();
							 response = asposeThreeDConversion.Convert(isFileUploaded.FileName, isFileUploaded.FolderId,   outputType.ToLower().Replace(" ", ""));
