...
using Aspose.Slides.Cloud.Live.Demos.UI.Controllers;
...
namespace Aspose.Slides.Cloud.Live.Demos.UI.Models
{
	public class LandingPageModel
	{
		...
		public AsposeSlidesCloudContext AsposeSlidesCloudContext
		{
			get
			{
				if (_atcContext == null) _atcContext = new AsposeSlidesCloudContext(HttpContext.Current);
				return _atcContext;
			}
		}
		...
		public string UIBasePath => Configuration.AsposeSlidesCloudLiveDemosPath;
