...
{
	/// <summary>
	/// Wrapper class for Aspose.Slides Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposeSlidesCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeSlidesCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeSlidesCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeSlidesCloudContext atcc { set { atc = value; } }
		internal static AsposeSlidesCloudContext Current
		{
			get { return atc; }
		}
