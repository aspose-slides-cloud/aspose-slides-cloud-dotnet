...
namespace Aspose.Slides.Cloud.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeSlidesCloudLiveDemosPath = ConfigurationManager.AppSettings["AsposeSlidesCloudLiveDemosPath"].ToString();
		...
		private static string _asposeSlidesCloudAppsAssetURL = ConfigurationManager.AppSettings["AsposeSlidesCloudAppsAssetURL"];
		...
		public static string AsposeSlidesCloudLiveDemosPath
		{
			get { return _asposeSlidesCloudLiveDemosPath; }
		}		
		...
		public static string AsposeSlidesCloudAppsAssetURL
		{
            get { return _asposeSlidesCloudAppsAssetURL; }
        }
